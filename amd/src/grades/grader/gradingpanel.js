...
/**
 * Grading panel for gradingform_enhancedrubric.
 *
 * @module     gradingform_enhancedrubric/grades/grader/gradingpanel
...
export const fetchCurrentGrade = (component, contextid, itemname, gradeduserid) => {
    return fetchMany([{
        methodname: `gradingform_enhancedrubric_grader_gradingpanel_fetch`,
        args: {
            component,
            contextid,
            itemname,
...
export const storeCurrentGrade = async(component, contextid, itemname, gradeduserid, notifyUser, rootNode) => {
    ...
    if (compareData(form) === true) {
        return normaliseResult(await fetchMany([{
            methodname: `gradingform_enhancedrubric_grader_gradingpanel_store`,
            args: {
                component,
                contextid,
                itemname,
