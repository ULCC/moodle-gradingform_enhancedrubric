...
class fetch_test extends advanced_testcase {
    ...
    public function test_execute_fetch_empty(): void {
        ...
        $this->assertArrayHasKey('section', $result['grade']);
        $sections = $result['grade']['section'];

        foreach ($sections as $sectionid => $section) {
            $this->assertArrayHasKey('criteria', $result['grade']['section'][$sectionid]);
            $criteria = $result['grade']['section'][$sectionid]['criteria'];
