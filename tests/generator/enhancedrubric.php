...
class enhancedrubric {
    ...
    /**
     * Create a new gradingform_enhancedrubric_generator_rubric.
     *
     * @param string $name
    ...
    public function __construct(string $name, string $description) {
        ...
        $this->set_option('showtotal', 1);
        $this->set_option('showminimum', 1);
        $this->set_option('showminimumgrader', 1);
    }
